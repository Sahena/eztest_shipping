 ...
 */
package com.assign.eztest.filter;
...
@WebFilter(filterName = "AuthenticationFilter", urlPatterns = "/*",
        initParams = @WebInitParam(name = "avoid-urls", value = "/login,/index,/resources/"))
...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        for (String avoidUrl : urlList) {

            System.out.println("Request Url is" + url);
            System.out.println("\nAvoid url is" + avoidUrl);
        ...
        try {
            ...
            if (!isRequestAllowed) {
                ...
                if (session == null && url.equalsIgnoreCase("/dashboard")) {
                    if (req.getMethod().equalsIgnoreCase("POST")) {
                        boolean isAuthentication = checkLogin(req, res);
                        if (isAuthentication) {
                    ...
                    if (url.equalsIgnoreCase("/dashboard")) {
                        if (req.getMethod().equalsIgnoreCase("POST")) {
                            boolean role = checkLogin(req, res);
                            if (role) {
                                chain.doFilter(req, res);
                                return;
                            }
    ...
    private boolean checkLogin(HttpServletRequest req, HttpServletResponse res) {
        ...
        UserDao userDaoObj = new UserDao(con);
        ...
        boolean isAuthentication = userDaoObj.authenticate(userModel);
        if (isAuthentication) {
            authenticate = true;
